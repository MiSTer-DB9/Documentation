...
If you want the technical detail, see [../maintainer-guide/the Saturn-2P-ghost rule](../maintainer-guide/the Saturn-2P-ghost rule).
...
If you want the technical detail, see [../maintainer-guide/the MT32 anti-contention rule](../maintainer-guide/the MT32 anti-contention rule).
